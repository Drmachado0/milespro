...
const actions: QuickAction[] = [
  ...
  { to: '/agencia/venda', icon: Send, label: 'Venda', requiredTier: 'pro' },
];
...
export function MobileFAB() {
  ...
  const visibleActions = actions.filter((a) => !a.requiredTier || hasTier(a.requiredTier));
  ...
  return (
    ...
    >
      ...
      >
        {visibleActions.map(({ to, icon: Icon, label }) => (
