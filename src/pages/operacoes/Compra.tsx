    ...
    <DashboardLayout title="Compra">
      <div className="space-y-6">
        <PageHeader
          ...
          subtitle="Registre aquisição de milhas ou pontos de qualquer programa"
        />

        <SectionErrorBoundary fallbackTitle="Erro ao carregar formulário">
          <Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">{getCurrencySymbol()}</span>
                    <Input
                      value={formatReadOnlyValue(costPerThousand)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Nenhum cartão associado" />
                    </SelectTrigger>
                    <SelectContent>
