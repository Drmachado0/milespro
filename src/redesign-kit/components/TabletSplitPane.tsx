...
/**
 * Tablet split-pane: master-list + detail layout responsivo.
 *
 * - Mobile/tablet portrait (<1024px): empilhamento vertical
 * - Tablet landscape / desktop (≥1024px): master 360px sticky + detail rolável
 *
 * Use em páginas com listas longas onde clicar num item carrega detalhe
 * (mensagens, orçamentos, promoções, programas, conversas, etc.).
 * Cada coluna rola independente em viewports maiores.
 *
 * Usage:
 *   <TabletSplitPane
 *     master={<ListaMensagens items={items} selected={selected} onSelect={setSelected} />}
 *     detail={selected ? <DetalheMensagem msg={selected} /> : <EmptyState ... />}
 *     masterHeader={<BuscaERFiltros />}
 *   />
 */
